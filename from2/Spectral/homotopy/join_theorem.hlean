...
namespace retraction
  variables {A B C : Type _} (r2 : B → C) (r1 : A → B)


  @[hott] def is_retraction_compose
  ...
  @[hott] def is_retraction_compose_equiv_left [Hr2 : is_equiv r2] [Hr1 : is_retraction r1] : is_retraction (r2 ∘ r1) :=
  begin
    apply is_retraction_compose,
  end

  @[hott] def is_retraction_compose_equiv_right [Hr2 : is_retraction r2] [Hr1 :  is_equiv r1] : is_retraction (r2 ∘ r1) :=
  begin
    apply is_retraction_compose,
  end
...
@[hott] theorem is_conn_join : is_conn (m +2+ n) (join X Y) :=
begin
  apply is_conn.intro,
  intro V,
