...
namespace pushout
  ...
  -- structure span2 : Type _ :=
  --   {A₀₀ A₀₂ A₀₄ A₂₀ A₂₂ A₂₄ A₄₀ A₄₂ A₄₄ : Type _}
  --   {f₀₁ : A₀₂ → A₀₀} {f₂₁ : A₂₂ → A₂₀} {f₄₁ : A₄₂ → A₄₀}
  --   {f₀₃ : A₀₂ → A₀₄} {f₂₃ : A₂₂ → A₂₄} {f₄₃ : A₄₂ → A₄₄}
  --   {f₁₀ : A₂₀ → A₀₀} {f₁₂ : A₂₂ → A₀₂} {f₁₄ : A₂₄ → A₀₄}
  --   {f₃₀ : A₂₀ → A₄₀} {f₃₂ : A₂₂ → A₄₂} {f₃₄ : A₂₄ → A₄₄}
  ...
  structure three_by_three_span : Type _ :=
    {A₀₀ A₂₀ A₄₀ A₀₂ A₂₂ A₄₂ A₀₄ A₂₄ A₄₄ : Type _}
    {f₁₀ : A₂₀ → A₀₀} {f₃₀ : A₂₀ → A₄₀}
    {f₁₂ : A₂₂ → A₀₂} {f₃₂ : A₂₂ → A₄₂}
    {f₁₄ : A₂₄ → A₀₄} {f₃₄ : A₂₄ → A₄₄}
...
check (pushout.functor (f₂₁ E) (f₀₁ E) (f₄₁ E) (s₁₁ E) (s₃₁ E))
  @[hott] def pushout2hv (E : three_by_three_span) : Type _ :=
  pushout (pushout.functor (f₂₁ E) (f₀₁ E) (f₄₁ E) (s₁₁ E) (s₃₁ E))
          (pushout.functor (f₂₃ E) (f₀₃ E) (f₄₃ E) (s₁₃ E) (s₃₃ E))

  @[hott] def pushout2vh (E : three_by_three_span) : Type _ :=
  pushout (pushout.functor (f₁₂ E) (f₁₀ E) (f₁₄ E) (s₁₁ E)⁻¹ʰᵗʸ (s₁₃ E)⁻¹ʰᵗʸ)
          (pushout.functor (f₃₂ E) (f₃₀ E) (f₃₄ E) (s₃₁ E)⁻¹ʰᵗʸ (s₃₃ E)⁻¹ʰᵗʸ)

  @[hott] def three_by_three (E : three_by_three_span) : pushout2hv E ≃ pushout2vh E := sorry
