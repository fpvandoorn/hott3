...
section short_five
  ...
  @[hott] lemma short_five_mono [embh : is_embedding h] [embl : is_embedding l] :
    is_embedding k :=
  ...
  @[hott] lemma short_five_epi (surjh : is_surjective h) (surjl : is_surjective l) :
    is_surjective k :=
...
section strong_four
  ...
  variables {A B C D A' B' C' D' : Type _}
...
@[hott] theorem strong_four_a (epiα : is_surjective α) (monoδ : is_embedding δ) (c : C) (γc0 : γ c = 0) :
  Σ b, (β b = 0 × σ b = c) :=
