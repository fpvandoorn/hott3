...
/-  namespace tensor_group
  ...
  inductive tensor_rel_type : free_ab_group (Set_of_Group A ×t Set_of_Group B) → Type _ :=
  ...
  @[hott] def tensor_rel' (x : free_ab_group (Set_of_Group A ×t Set_of_Group B)) : Prop :=
  ∥ tensor_rel_type x ∥

  @[hott] def tensor_group_rel (A B : AbGroup)
    : normal_subgroup_rel (free_ab_group (Set_of_Group A ×t Set_of_Group B)) :=
  sorry /- relation generated by tensor_rel'-/

  @[hott] def tensor_group : AbGroup :=
