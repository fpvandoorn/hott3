...
namespace eq
  ...
  variables {A A' : Type _} {B : A → Type _}
  ...
  @[hott] def idsquareo [reducible] (b₀₀ : B a₀₀) := @squareover.idsquareo A B a₀₀ b₀₀
  @[hott] def idso      [reducible]               := @squareover.idsquareo A B a₀₀ b₀₀
...
-/
  ...
  /-
  @[hott] def squareover_equiv_pathover (q₁₀ : b₀₀ =[p₁₀] b₂₀) (q₁₂ : b₀₂ =[p₁₂] b₂₂)
    (q₀₁ : b₀₀ =[p₀₁] b₀₂) (q₂₁ : b₂₀ =[p₂₁] b₂₂)
  ...
  @[hott] def eq_of_vdeg_squareover {q₁₀' : b₀₀ =[p₁₀] b₂₀}
  ...
  -- @[hott] def vdeg_tr_squareover {q₁₂ : p₀₁ ▸ b₀₀ =[p₁₂] p₂₁ ▸ b₂₀} (r : q₁₀ =[_] q₁₂)
  ...
  @[hott] def eq_pathover_dep {f g : Πa, B a} {p : a = a'} {q : f a = g a}
  ...
  @[hott] def pathover_pathover {a' a₂' : A'} {p : a' = a₂'} {f g : A' → A}
  ...
  @[hott] def sigma_square {v₀₀ v₂₀ v₀₂ v₂₂ : Σa, B a}
