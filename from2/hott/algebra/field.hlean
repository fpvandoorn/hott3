...
namespace algebra
structure division_ring [class] (A : Type _) extends ring A, has_inv A, zero_ne_one_class A :=
...
section division_ring
  ...
  @[hott] theorem inv_eq_one_div (a : A) : a⁻¹ = 1 / a := !one_mul⁻¹
  ...
  @[hott] theorem mul_div_assoc (a b : A) : (a * b) / c = a * (b / c) := !mul.assoc
  ...
  @[hott] theorem zero_div (a : A) : 0 / a = 0 := !zero_mul
...
structure field [class] (A : Type _) extends division_ring A, comm_ring A
...
structure discrete_field [class] (A : Type _) extends field A :=
...
section discrete_field
  ...
  @[hott] def discrete_field.to_integral_domain [trans_instance] : integral_domain A :=
  ⦃ integral_domain, s,
