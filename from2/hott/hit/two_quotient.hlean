...
namespace simple_two_quotient
  ...
  inductive simple_two_quotient_rel : C → C → Type _ :=
  | Rmk {} : Π{a : A} {r : T a a} (q : Q r) (x : circle),
      simple_two_quotient_rel (f q x) (pre_aux q)

  open simple_two_quotient_rel
  @[hott] def simple_two_quotient := quotient simple_two_quotient_rel
  ...
  @[hott] def incl2 (q : Q r) : inclt r = idp :=
  ...
  begin
    ...
    { refine (pre_rec _ _ _ a),
      { exact P0},
      { intros a r q, exact incl2' q base ▸ P0 a},
      { intros a a' s, exact pathover_of_pathover_ap P i (P1 s)}},
  ...
  @[hott] theorem rec_incl1 {P : D → Type _} (P0 : Π(a : A), P (incl0 a))
    (P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a =[incl1 s] P0 a')
    (P2 : Π⦃a : A⦄ ⦃r : T a a⦄ (q : Q r),
  ...
  @[hott] theorem rec_inclt {P : D → Type _} (P0 : Π(a : A), P (incl0 a))
    (P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a =[incl1 s] P0 a')
    (P2 : Π⦃a : A⦄ ⦃r : T a a⦄ (q : Q r),
  ...
  @[hott] def elim_incl2' {P : Type _} {P0 : A → P}
    {P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a = P0 a'}
    (P2 : Π⦃a : A⦄ ⦃r : T a a⦄ (q : Q r), e_closure.elim P1 r = idp)
  ...
  @[hott] theorem elim_incl2 {P : Type _} (P0 : A → P)
    (P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a = P0 a')
    (P2 : Π⦃a : A⦄ ⦃r : T a a⦄ (q : Q r), e_closure.elim P1 r = idp)
    ⦃a : A⦄ ⦃r : T a a⦄ (q : Q r)
...
export simple_two_quotient
attribute simple_two_quotient.j simple_two_quotient.incl0
attribute simple_two_quotient.rec simple_two_quotient.elim [recursor 8]
--attribute simple_two_quotient.elim_type -- TODO
attribute simple_two_quotient.rec_on simple_two_quotient.elim_on
--attribute simple_two_quotient.elim_type_on -- TODO
...
namespace two_quotient
  ...
  parameters {A : Type _}
             (R : A → A → Type _)
  local abbreviation T := e_closure R -- the (type-valued) equivalence closure of R
  parameter  (Q : Π⦃a a'⦄, T a a' → T a a' → Type _)
  variables ⦃a a' a'' : A⦄ {s : R a a'} {t t' : T a a'}

  inductive two_quotient_Q : Π⦃a : A⦄, e_closure R a a → Type _ :=
  | Qmk : Π⦃a a' : A⦄ ⦃t t' : T a a'⦄, Q t t' → two_quotient_Q (t ⬝r t'⁻¹ʳ)
  open two_quotient_Q
  local abbreviation Q2 := two_quotient_Q

  @[hott] def two_quotient := simple_two_quotient R Q2
  @[hott] def incl0 (a : A) : two_quotient := incl0 _ _ a
  @[hott] def incl1 (s : R a a') : incl0 a = incl0 a' := incl1 _ _ s
  @[hott] def inclt (t : T a a') : incl0 a = incl0 a' := e_closure.elim incl1 t
  @[hott] def incl2 (q : Q t t') : inclt t = inclt t' :=
  ...
  @[hott] theorem rec_incl1 {P : two_quotient → Type _} (P0 : Π(a : A), P (incl0 a))
    (P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a =[incl1 s] P0 a')
    (P2 : Π⦃a a' : A⦄ ⦃t t' : T a a'⦄ (q : Q t t'),
      change_path (incl2 q) (e_closure.elimo incl1 P1 t) = e_closure.elimo incl1 P1 t')
  ...
  @[hott] theorem rec_inclt {P : two_quotient → Type _} (P0 : Π(a : A), P (incl0 a))
    (P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a =[incl1 s] P0 a')
    (P2 : Π⦃a a' : A⦄ ⦃t t' : T a a'⦄ (q : Q t t'),
      change_path (incl2 q) (e_closure.elimo incl1 P1 t) = e_closure.elimo incl1 P1 t')
  ...
  begin
    ...
    { exact P0 a},
    { exact P1 s},
    { exact abstract begin induction q with a a' t t' q,
  ...
  @[hott] def elim_inclt_rel {P : Type _} {P0 : A → P}
    {P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a = P0 a'}
    (P2 : Π⦃a a' : A⦄ ⦃t t' : T a a'⦄ (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
    ⦃a a' : A⦄ (r : R a a') : elim_inclt P2 [r] = elim_incl1 P2 r :=
  idp

  @[hott] def elim_inclt_inv {P : Type _} {P0 : A → P}
    {P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a = P0 a'}
    (P2 : Π⦃a a' : A⦄ ⦃t t' : T a a'⦄ (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
    ⦃a a' : A⦄ (t : T a a')
  ...
  @[hott] def elim_inclt_con {P : Type _} {P0 : A → P}
    {P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a = P0 a'}
    (P2 : Π⦃a a' : A⦄ ⦃t t' : T a a'⦄ (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
  ...
  @[hott] def inclt_rel (r : R a a') : inclt [r] = incl1 r := idp
  @[hott] def inclt_inv (t : T a a') : inclt t⁻¹ʳ = (inclt t)⁻¹ := idp
  @[hott] def inclt_con (t : T a a') (t' : T a' a'')
    : inclt (t ⬝r t') = inclt t ⬝ inclt t' := idp
end
end two_quotient

attribute two_quotient.incl0
attribute two_quotient.rec two_quotient.elim [recursor 8]
--attribute two_quotient.elim_type
attribute two_quotient.rec_on two_quotient.elim_on
--attribute two_quotient.elim_type_on
...
namespace trunc_two_quotient
  ...
  @[hott] def trunc_two_quotient := trunc n (two_quotient R Q)

  parameters {n R Q}
  @[hott] def incl0 (a : A) : trunc_two_quotient := tr (!incl0 a)
  @[hott] def incl1 (s : R a a') : incl0 a = incl0 a' := ap tr (!incl1 s)
  @[hott] def incltw (t : T a a') : incl0 a = incl0 a' := ap tr (!inclt t)
  @[hott] def inclt (t : T a a') : incl0 a = incl0 a' := e_closure.elim incl1 t
  @[hott] def incl2w (q : Q t t') : incltw t = incltw t' :=
  ap02 tr (!incl2 q)
  @[hott] def incl2 (q : Q t t') : inclt t = inclt t' :=
  ...
  @[hott] theorem rec_incl1 {P : trunc_two_quotient → Type _} [H : Πx, is_trunc n (P x)]
    (P0 : Π(a : A), P (incl0 a))
    (P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a =[incl1 s] P0 a')
    (P2 : Π⦃a a' : A⦄ ⦃t t' : T a a'⦄ (q : Q t t'),
      change_path (incl2 q) (e_closure.elimo incl1 P1 t) = e_closure.elimo incl1 P1 t')
  ...
  @[hott] theorem rec_inclt {P : trunc_two_quotient → Type _} [H : Πx, is_trunc n (P x)]
    (P0 : Π(a : A), P (incl0 a))
    (P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a =[incl1 s] P0 a')
    (P2 : Π⦃a a' : A⦄ ⦃t t' : T a a'⦄ (q : Q t t'),
      change_path (incl2 q) (e_closure.elimo incl1 P1 t) = e_closure.elimo incl1 P1 t')
  ...
  @[hott] def elim_incl1 {P : Type _} [H : is_trunc n P] {P0 : A → P}
    {P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a = P0 a'}
    (P2 : Π⦃a a' : A⦄ ⦃t t' : T a a'⦄ (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
    ⦃a a' : A⦄ (s : R a a') : ap (elim P0 P1 P2) (incl1 s) = P1 s :=
  !ap_compose⁻¹ ⬝ !elim_incl1

  @[hott] def elim_inclt {P : Type _} [H : is_trunc n P] {P0 : A → P}
    {P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a = P0 a'}
    (P2 : Π⦃a a' : A⦄ ⦃t t' : T a a'⦄ (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
    ⦃a a' : A⦄ (t : T a a') : ap (elim P0 P1 P2) (inclt t) = e_closure.elim P1 t :=
  ap_e_closure_elim_h incl1 (elim_incl1 P2) t
  ...
  @[hott] theorem elim_incl2 {P : Type _} [H : is_trunc n P] (P0 : A → P)
    (P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a = P0 a')
    (P2 : Π⦃a a' : A⦄ ⦃t t' : T a a'⦄ (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
    ⦃a a' : A⦄ ⦃t t' : T a a'⦄ (q : Q t t')
    : square (ap02 (elim P0 P1 P2) (incl2 q)) (P2 q) (elim_inclt P2 t) (elim_inclt P2 t') :=
  ...
  @[hott] def elim_inclt_rel {P : Type _} [is_trunc n P] {P0 : A → P}
    {P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a = P0 a'}
    (P2 : Π⦃a a' : A⦄ ⦃t t' : T a a'⦄ (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
    ⦃a a' : A⦄ (r : R a a') : elim_inclt P2 [r] = elim_incl1 P2 r :=
  idp

  @[hott] def elim_inclt_inv {P : Type _} [is_trunc n P] {P0 : A → P}
    {P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a = P0 a'}
    (P2 : Π⦃a a' : A⦄ ⦃t t' : T a a'⦄ (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
    ⦃a a' : A⦄ (t : T a a')
    : elim_inclt P2 t⁻¹ʳ = ap_inv (elim P0 P1 P2) (inclt t) ⬝ (elim_inclt P2 t)⁻² :=
  ...
  @[hott] def elim_inclt_con {P : Type _} [is_trunc n P] {P0 : A → P}
    {P1 : Π⦃a a' : A⦄ (s : R a a'), P0 a = P0 a'}
    (P2 : Π⦃a a' : A⦄ ⦃t t' : T a a'⦄ (q : Q t t'), e_closure.elim P1 t = e_closure.elim P1 t')
    ⦃a a' a'' : A⦄ (t : T a a') (t': T a' a'')
    : elim_inclt P2 (t ⬝r t') =
...
attribute trunc_two_quotient.incl0
attribute trunc_two_quotient.rec trunc_two_quotient.elim [recursor 10]
attribute trunc_two_quotient.rec_on trunc_two_quotient.elim_on
