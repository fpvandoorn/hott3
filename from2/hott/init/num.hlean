...
namespace pos_num
  ...
  @[hott] def le (a b : pos_num) : bool :=
  pos_num.lt a (succ b)
end pos_num

@[hott] def pos_num_has_mul [instance] : has_mul pos_num :=
has_mul.mk pos_num.mul

namespace num
  open pos_num

  @[hott] def pred (a : num) : num :=
...
@[hott] def num_has_mul [instance] : has_mul num :=
has_mul.mk num.mul
...
@[hott] def num_has_sub [instance] : has_sub num :=
has_sub.mk num.sub
