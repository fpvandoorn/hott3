...
namespace is_trunc
  @[hott] def is_contr.sigma_char (A : Type _) :
  ...
  @[hott] def is_trunc.pi_char (n : trunc_index) (A : Type _) :
  ...
  @[hott] def is_prop_is_trunc (n : trunc_index) :
    Π (A : Type _), is_prop (is_trunc n A) :=
  begin
    induction n,
    { intro A,
  ...
  @[hott] def is_trunc_succ_is_trunc [instance] (n m : ℕ₋₂) (A : Type _) :
